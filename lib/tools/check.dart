...
/// 消息类型过滤
bool isShowMsg(int mType) {
  if (mType != 103 && mType != 104 && mType != 11 && mType != 100) {
    return true;
  } else {
    return false;
  }
...
bool isWindows() {
  if (Platform.isWindows != null && Platform.isWindows) {
    return true;
  }
  return false;
}
...
bool isFuchsia() {
  if (Platform.isFuchsia != null && Platform.isFuchsia) {
    return true;
  }
  return false;
}
...
bool isLinux() {
  if (Platform.isLinux != null && Platform.isLinux) {
    return true;
  }
  return false;
}
...
bool isMacOS() {
  if (Platform.isMacOS != null && Platform.isMacOS) {
    return true;
  }
  return false;
}
