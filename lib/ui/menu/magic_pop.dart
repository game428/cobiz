...
class MagicPopAction {
  final String title;
  final int value;

  MagicPopAction(this.title, this.value);
}
...
class MagicPop extends StatefulWidget {
  ...
  final ValueChanged<MagicPopAction> onValueChanged;
  final List<MagicPopAction> actions;
  final Widget child;
...
class _WPopupMenuState extends State<MagicPop> {
  ...
  void onTap() {
    Navigator.push(
      ...
      widget.onValueChanged(widget.actions[index]);
    });
  }
}
...
class _PopupMenuRoute extends PopupRoute {
  ...
  _PopupMenuRoute(this.btnContext, this.actions, this._pageMaxChildCount,
      this.backgroundColor, this.isSelf, this.menuWidth, this.menuHeight) {
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return _MenuPopWidget(this.btnContext, _height, _width, actions,
        _pageMaxChildCount, backgroundColor, isSelf, menuWidth, menuHeight);
  }
    ...
    Widget view() {
      ...
      var row = Row(
        ...
        children: <Widget>[
          ...
          // 中间是ListView
          Flexible(
              child: _buildList(_curPageChildCount, _curPageWidth,
          ...
          _curArrowCount > 0
              ? InkWell(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      Icons.chevron_right,
                      color: (_curPage + 1) * widget._pageMaxChildCount >=
                              widget.actions.length
                          ? Colors.grey
                          : Colors.white,
                    ),
...
class _PopupMenuRouteLayout extends SingleChildLayoutDelegate {
  ...
  // Rectangle of underlying button, relative to the overlay's cbpensions.
